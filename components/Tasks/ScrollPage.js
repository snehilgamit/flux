...
const ScrollPage = ({ children, visible ,closeEvent}) => {
    return (
        <div className='h-[95%] max-[342px]:h-[95%] rounded-t-3xl border-t-[5px] border-t-[#9AF6C1] bg-[#000] fixed -bottom-[0%] transition-all duration-500 ease-in-out z-50 w-full overflow-y-scroll' style={{ bottom: visible ? 0 : '-100%' }}>
